    ...
    var CarouselEvo = function(element, options) {
        ...
        var slideClick = function(event) {
            ...
            if ($this.index() != currentSlide) {
                ...
                $this.parent().find('.active-slide').removeClass('active-slide');
                $this.addClass('active-slide');
                // use for cs68
                $('.tab-state li').removeClass('active2'); 
                $('.tab-state li').eq(currentSlide).addClass('active2');

                // $this.parent().find('img').removeClass('active-slide');
                // $this.parent().find('.description').removeClass('active-slide');
                // $this.find('img').addClass('active-slide');
                // $this.find('.description').addClass('active-slide');
        ...
        // use for cs68
        $('.tab-state li').on('click', function(event) {
            var $this = $(this);
        ...
        var initDirectionButton = function() {
            var el = element;
            el.append('<div class="nextButton"><i class="icon-arrow2"></i></div><div class="prevButton"><i class="icon-arrow1"></i></div>');
            el.children('.nextButton').bind('click', function(event) {
                goTo(currentSlide + 1, true, false);
                el.find('.active-slide').removeClass('active-slide');
                el.find('.slideItem').eq(currentSlide).addClass('active-slide');

                // use for cs68
                $('.tab-state li').removeClass('active2'); 
                $('.tab-state li').eq(currentSlide).addClass('active2');
                // el.find('.slideItem').find('img').removeClass('active-slide');
                // el.find('.slideItem').find('.description').removeClass('active-slide');

                // el.find('.slideItem').eq(currentSlide).find('img').addClass('active-slide');
                // el.find('.slideItem').eq(currentSlide).find('.description').addClass('active-slide');
            });
